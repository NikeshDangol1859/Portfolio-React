  ...
  return (
    <>    
        ...
        <div className="main-home">
            ...
            <h2 className="text-center">I like <span className="animation-text text-start text-decoration-underline "> </span> </h2>                   
            <div className="icons">
            ...
            <div className="btnss">
                <a href="/CV(Nikesh).pdf" download className="text-decoration-none">
