    ...
    <>
                ...
                <div className="container-about mt-5">
                    ...
                    <div className="col-md-12 text-light p-5">
                        ...
                        <p>I am <span className="fw-bold text-warning">Nikesh Dangol </span>, a passionate and dedicated
                            ...
                            contribution.</p> 
                        <p>I am a lifelong learner, always seeking to improve my skills
                        ...
                        <p>I am a strong believer in the importance of teamwork and collaboration
                        ...
                        <a href="/resume" className="text-warning justify-content-end">Know More <span className="know-animation" /></a>
                        </div>
